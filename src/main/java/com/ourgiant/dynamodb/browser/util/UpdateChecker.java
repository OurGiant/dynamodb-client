...
/**
 * Checks GitHub's releases API for a newer DynamoDB Browser version. This is the app's only
 * outbound network call at runtime that isn't a DynamoDB/STS API request. Ported from
 * kiro-control-panel/doc-scrubber's same feature.
 */
public final class UpdateChecker {
    private static final Logger logger = LoggerFactory.getLogger(UpdateChecker.class);
    private static final String RELEASES_URL = "https://api.github.com/repos/OurGiant/dynamodb-client/releases/latest";
    ...
    public static Optional<ReleaseInfo> fetchLatestRelease() {
        try {
            ...
            HttpRequest request = HttpRequest.newBuilder()
                ...
                .header("User-Agent", "dynamodb-client")
