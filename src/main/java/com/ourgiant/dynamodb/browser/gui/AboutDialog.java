...
import com.ourgiant.dynamodb.browser.util.NetworkFetchException;
...
/** App name, version, and copyright, plus an update check against GitHub releases. */
class AboutDialog extends JDialog {
    ...
    AboutDialog(Frame parent, UpdateChecker.ReleaseInfo knownNewerRelease) {
        super(parent, "About DynamoDB Browser", knownNewerRelease == null);
    ...
    private static String buildHtml(String currentVersion) {
        return """
            ...
            <h2 style="margin-top: 0;">DynamoDB Browser</h2>
            <p>Version %s</p>
            <p>A Java Swing desktop application for browsing and querying AWS DynamoDB
            tables, connecting via local AWS profiles.</p>
            <p>&copy; OurGiant</p>
            </body></html>
